...
This dataset is about attrition, the rate at which employees are leaving a company. Our goal is to identify why employees are no longer with the company.
...
It appears most people who are leaving are younger (under xx age). This makes sense because younger people are earlier in their careers, so they have fewer attachments or loyalty to the company, particularly with Millennials and Generation Z. 
